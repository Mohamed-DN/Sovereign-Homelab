...
2. [Runbook 02: AdGuard Home](../02_network_vpn/doc_02_adguard_home.md)
3. [Runbook 03: Nginx Proxy Manager](../02_network_vpn/doc_03_nginx_proxy_manager.md)
4. [Runbook 04: Headscale VPN](../02_network_vpn/doc_04_headscale_vpn.md)

Before adding real personal data, complete:

- [Runbook 06: Headscale Hardening](../02_network_vpn/doc_06_headscale_hardening.md)
- [Runbook 09: Backup and DR](../05_backup_dr/doc_09_backup_dr.md)

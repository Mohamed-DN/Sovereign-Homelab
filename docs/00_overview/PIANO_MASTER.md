...
| 19 | **Momo non programma**, e il motore per farlo è già installato e spento | `code_execution`, `terminal`, `skills`, `delegation`, `cronjob`, `browser` e **sette ambienti sandbox** sono dentro hermes-agent e fuori dalla configurazione di Momo. Verificato il 2026-08-04. **P1 (la gabbia) fatta e provata dal vivo il 2026-08-04** — [momo-sandbox.md](../04_apps/momo-sandbox.md). Resta: `code_execution` acceso (P2), il Guardrail esteso all'esito dei test (P3), poi la libreria (P4) | [PIANO_MOMO_PROGRAMMATORE](PIANO_MOMO_PROGRAMMATORE.md) |

...
| 19 | **Momo non programma**, e il motore per farlo è già installato e spento | `code_execution`, `terminal`, `skills`, `delegation`, `cronjob`, `browser` e **sette ambienti sandbox** sono dentro hermes-agent e fuori dalla configurazione di Momo. Verificato il 2026-08-04. **P1-P4 fatte**: sandbox provata dal vivo, `execute_code` acceso come strumento a parte ([`momo-esegui-codice.py`](../../scripts/momo/momo-esegui-codice.py)), Guardrail esteso all'esito reale (35/35 test), skill accese con approvazione umana obbligatoria — [momo-skills.md](../04_apps/momo-skills.md). **Scoperta grossa**: Momo gira come **root** sulla stessa LXC dei segreti; la raccomandazione ufficiale di NousResearch per un gateway come Telegram è "whole-process wrapping", non solo isolamento del backend comandi — voce nuova [§7-bis](PIANO_MOMO_PROGRAMMATORE.md#7-bis-il-whole-process-wrapping-trovato-cercando-la-risposta-ufficiale), da pianificare a parte | [PIANO_MOMO_PROGRAMMATORE](PIANO_MOMO_PROGRAMMATORE.md) |
| 20 | **PixelRAG**: cercare i documenti da come sono fatti | è la risposta migliore alla voce 3 (Nextcloud) e vale doppio sulle scansioni, dove non c'è testo da estrarre. Apache-2.0, tutto in casa. Il modello con gli occhi però non entra nella T600 | [punto 18-quater](PIANO_GENERALE.md) |
| 21 | **Momo su WhatsApp** — e la decisione è sua, non tecnica | l'adattatore è **già installato** (3 trasporti). Ma la via non ufficiale brucia il numero in 2-8 settimane, e quella ufficiale dal 15/1/2026 vieta gli assistenti generalisti. Le opzioni: non farlo, un numero sacrificabile, o Matrix | [punto 22](PIANO_GENERALE.md) |
| 22 | **Headroom**, la compressione del contesto | non è una mancanza ma un limite: la T600 ha 4 GB e **è il contesto** a decidere quali modelli ci stanno dentro. Valutato il 2026-08-04 come il migliore di dodici tecnologie proposte, con tre riserve scritte (è lossy, è un salto in più che può cadere, i numeri vanno rimisurati qui) | [punto 18-ter](PIANO_GENERALE.md) · [valutazione](VALUTAZIONE_TECNOLOGIE_2026-08.md) |

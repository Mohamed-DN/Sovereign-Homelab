...
| **P2** | **Accendere `code_execution` legato solo a quella sandbox** (`docker_network: momo-sandbox`, `docker_extra_args` con l'etichetta del guardiano — vedi [momo-sandbox.md](../04_apps/momo-sandbox.md) §3), e provarlo con un compito innocuo | il primo momento in cui Momo esegue qualcosa. Va guardato, non dedotto | ~2 h |

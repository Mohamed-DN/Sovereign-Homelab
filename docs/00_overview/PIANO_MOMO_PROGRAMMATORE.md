...
|---|---|---|---|
| **P1** | **La sandbox, vuota**: immagine Docker dedicata, niente segreti, niente LAN, etichetta e tetto di durata, teardown provato **prima** di darla a Momo | si costruisce la gabbia prima di metterci dentro qualcosa. Ed è la sola parte che, se sbagliata, si paga cara | ~4 h |
| **P2** | **Accendere `code_execution` legato solo a quella sandbox**, e provarlo con un compito innocuo | il primo momento in cui Momo esegue qualcosa. Va guardato, non dedotto | ~2 h |

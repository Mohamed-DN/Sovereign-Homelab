...
| `trust-portal` | `nginx` | `TRUST_PORTAL_NGINX_TAG` | `1.30.3-alpine` | Official Nginx Docker image stable tag | Static LAN/VPN CA onboarding portal. It serves only public trust artifacts and runs read-only. |
